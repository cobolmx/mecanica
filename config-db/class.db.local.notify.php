...
//define('DB_HOST', '192.168.4.168'); // set database host localhost
//define('DB_HOST', '192.168.4.63'); // set database host localhost
...
// define('DB_NAME', 'scrmtest'); // set database name
define('DB_NAME', 'scrm'); // set database name
