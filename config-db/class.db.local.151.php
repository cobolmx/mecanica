...
define('DB_HOST', '192.168.4.151'); // set database host
define('DB_USER', 'reports'); // set database user
define('DB_PASS', 'Reports2016'); // set database password
...
class DB {
    ...
    public function log_db_errors($error, $query, $severity) {
        ...
        $headers .= 'From: Croom system <irodriguez@solucenterint.com>' . "\r\n";
