...
define('DB_HOST_2', '192.168.4.146'); // set database host  <-- production
define('DB_USER_2', 'reports'); // set database user
define('DB_PASS_2', 'Reports2016'); // set database password
define('DB_NAME_2', 'asterisk'); // set database name
define('SEND_ERRORS_TO_2', 'irodriguez@solucenterint.com'); //set email notification email address
define('DISPLAY_DEBUG_2', true); //display db errors?
...
class DB2 {
    ...
    public function log_db_errors($error, $query, $severity) {
        ...
        $headers .= 'To: Admin <' . SEND_ERRORS_TO_2 . '>' . "\r\n";
        ...
        mail(SEND_ERRORS_TO_2, 'Database Error', $message, $headers);
    ...
    public function __construct() {
        ...
        $this->link = new mysqli(DB_HOST_2, DB_USER_2, DB_PASS_2, DB_NAME_2);
